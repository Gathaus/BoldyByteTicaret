...
{
    /// <inheritdoc />
    public partial class SimplifiedEcommerceMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CssClass = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasInstallment = table.Column<bool>(type: "boolean", nullable: false),
                    SortOrder = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Brands_IsActive_SortOrder",
                table: "Brands",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_CategoryId_IsActive_IsFeatured",
                table: "Products",
                columns: new[] { "CategoryId", "IsActive", "IsFeatured" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_IsActive_SortOrder",
                table: "Products",
                columns: new[] { "IsActive", "SortOrder" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tags_Type_IsActive_SortOrder",
                table: "Tags",
